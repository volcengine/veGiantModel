...
from veGiantModel.megatron.checkpointing import fix_query_key_value_ordering
from veGiantModel.megatron.checkpointing import get_checkpoint_tracker_filename
from veGiantModel.megatron.checkpointing import get_checkpoint_name
from veGiantModel.megatron import mpu, get_tokenizer
from veGiantModel.megatron.model.bert_model import bert_position_ids
...
class BiEncoderModel(MegatronModule):
    ...
    def init_state_dict_from_bert(self):
        ...
        try:
            ...
            from veGiantModel.megatron.fp16_deprecated import loss_scaler
